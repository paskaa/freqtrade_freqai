"""
ADX/DI Strategy - v4014 (Production Release)
============================================

基于v40 v14优化版：
- 提高ADX阈值: Tier1=28, Tier2=32, Tier3=35, Tier4=40
- 收紧分层止损：Tier1: 18%, Tier2: 15%, Tier3: 12%, Tier4: 10%
- 根据BTC 1d EMA判断市场方向，禁止逆势交易
- 优化后利润提升56.6% (v7: 4277U -> v4014: 6699U)
"""
...
class Alvinchen_v4014(IStrategy):
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # 根据市场状态过滤方向
        # BTC 1d数据明确指示牛市/熊市时禁止反向交易
        if market_regime == 'bullish':
            short_entry = short_entry & False
        elif market_regime == 'bearish':
            long_entry = long_entry & False
        # neutral: 不强制过滤方向，入场条件的major_bullish/major_bearish已做过滤
