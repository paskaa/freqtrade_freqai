...
class Alvinchen_v34_27(IStrategy):
    INTERFACE_VERSION = 3
    """
    ADX/DI Strategy without FreqAI - v34.27 (Multi-Timeframe)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_entry = (
            ...
            (dataframe['adx'] > 55) &   # ADX > 55 极强上升趋势确认 (原50)
            (dataframe['di_diff'] > 20) &  # DI_diff > 20 极强多头 (原18)
