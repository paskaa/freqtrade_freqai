...
class Alvinchen_v35(IStrategy):
    INTERFACE_VERSION = 3
    """
    ADX/DI Strategy without FreqAI - v35 (Multi-Timeframe)

    Key features:
    - No FreqAI (pure technical analysis)
    - Optimized long entry conditions (ADX>55, DI_diff>20)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # v34.21: ADX>55, DI_diff>20, RSI 60-65
        long_entry = (
