...
class Alvinchen_v34_28(IStrategy):
    INTERFACE_VERSION = 3
    """
    ADX/DI Strategy without FreqAI - v34.28 (Multi-Timeframe)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_entry = (
            ...
            (dataframe['adx'] > 60) &   # ADX > 60 极强上升趋势确认 (原55)
            (dataframe['di_diff'] > 25) &  # DI_diff > 25 极强多头 (原20)
