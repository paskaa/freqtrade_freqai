"""
ADX/DI Strategy - v4018g (出场确认优化版)
==========================================

基于v4017优化：
- v4018g核心改动:
  1. custom_exit: level1_profit_exit reverse_signals阈值从3提高到4
  2. confirm_trade_exit: 拒绝trailing_stop_exit当利润小(<3%)且趋势延续
...
class Alvinchen_v4022(IStrategy):
    """
    v4016 - 价格位置优化版
    ...
    def custom_exit(
        ...
        **kwargs
        ...
        # v4018g: 提高level1_profit_exit门槛，让利润跑更久
