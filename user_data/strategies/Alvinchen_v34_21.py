...
class Alvinchen_v34_21(IStrategy):
    INTERFACE_VERSION = 3
    """
    ADX/DI Strategy without FreqAI - v34.20 (Multi-Timeframe)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        """
        Entry conditions - v34.21: 提高指标准确性
        ...
        long_entry = (
            ...
            (dataframe['di_diff'] > 8) &  # DI_diff > 8 明确多头
            macd_bullish &           # MACD > 0 确认多头
            (dataframe['rsi'] > 55) &  # RSI > 55 偏多
            (dataframe['rsi'] < 70) &  # RSI < 70 避免超买
