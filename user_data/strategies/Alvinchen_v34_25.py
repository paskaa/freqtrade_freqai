...
class Alvinchen_v34_25(IStrategy):
    INTERFACE_VERSION = 3
    """
    ADX/DI Strategy without FreqAI - v34.25 (Multi-Timeframe)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        long_entry = (
            ...
            (dataframe['adx'] > 45) &   # ADX > 45 极强上升趋势确认 (原40)
            (dataframe['di_diff'] > 15) &  # DI_diff > 15 极强多头 (原12)
